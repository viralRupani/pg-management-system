 ...
 * (z-50) so failures show over open modals. Errors only for now — `tone` is kept
 * internal so a future "success" is a one-line addition.
 */
...
export function useToast(): { error: (message: string) => void } {
