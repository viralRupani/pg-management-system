...
export default function ManagersPage() {
  ...
  const load = useCallback(async () => {
    try {
      ...
      setLoadFailed(true);
      toast.error(toMessage(err, "Could not load managers."));
    }
  }, [toast]);
...
function AddManagerDialog({
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      toast.error(toMessage(err, "Could not add the manager."));
      setSubmitting(false);
    }
  }
...
function DeactivateDialog({
  ...
  async function confirm() {
    ...
    try {
      ...
      toast.error(toMessage(err, "Could not deactivate the manager."));
      setSubmitting(false);
    }
  }
